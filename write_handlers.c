 ...
 * @precision: precision 
 * @size: sizes
 * Return: Char numbers - Upon Success
 */
...
/**
 * write_num - function writes number using a bufffer
 * @ind: Index at which the number
 * Return: printed char - Upon SUccess
 */
 ...
 * @is_negative: Number indicating negative num
